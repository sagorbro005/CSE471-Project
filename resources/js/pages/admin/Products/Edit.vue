<template>
  <AdminLayout>
    ...
    <div class="flex justify-between items-center mb-8">
      ...
      <Link :href="route('admin.products')" class="text-blue-500 hover:text-blue-600">
...
const form = ref({
  ...
  currentImage: props.product.image,
  image: null
});
...
function submitForm() {
  ...
  Object.entries(form.value).forEach(([key, value]) => {
    if (value !== null && key !== 'currentImage') payload.append(key, value);
  });
  router.post(route('admin.products.update', props.product.slug), payload, {
    forceFormData: true,
    method: 'post',
    _method: 'put'
  });
